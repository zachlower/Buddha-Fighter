...
public class PlatformerMotor2DEditor : Editor
{
    ...
    private static bool _showSlashing;
    ...
    private readonly Property NON_STICK_LAYER_MASK = new Property("nonStickLayerMask", "Non-Stick Layer Mask");
    ...
    private readonly Property WALL_CLIP = new Property("wallClip", "Wall grab soundFX");
    private readonly Property JUMP_CLIP = new Property("jumpClip", "Jump soundFX");
    ...
    private readonly Property DASH_CLIP = new Property("dashClip", "Dash Clip");
    ...
    private readonly Property ENABLE_SLASHES = new Property("enableSlashes", "Enable Slashes");
    private readonly Property SLASH_CLIP = new Property("slashClip", "Slash soundFX");
    private readonly Property SLASH_DISTANCE = new Property("slashDistance", "Slash Distance");
    private readonly Property SLASH_EASING_FUNCTION = new Property("slashEasingFunction", "Slash Easing Function");
    private readonly Property SLASH_DURATION = new Property("slashDuration", "Slash Duration");
    private readonly Property END_SLASH_DELAY = new Property("endSlashNoGravityDuration", "Gravity Delay After Slash");
    #endregion
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_showGeneral)
        {
            ...
            DisplayRegularField(NON_STICK_LAYER_MASK);
            ...
            DisplayRegularField(WALL_CLIP);
            DisplayRegularField(JUMP_CLIP);
        ...
        _showSlashing = EditorGUILayout.Foldout(_showSlashing, "Slashing");

        if (_showSlashing)
        {
            DisplayRegularField(ENABLE_SLASHES);

            if (_properties[ENABLE_SLASHES.name].hasMultipleDifferentValues || _properties[ENABLE_SLASHES.name].boolValue)
            {
                DisplayRegularField(SLASH_CLIP);
                DisplayRegularField(SLASH_DISTANCE);

                DisplayTimingField(SLASH_DURATION);

                DisplayRegularField(SLASH_EASING_FUNCTION);
                DisplayTimingField(END_SLASH_DELAY);
            }
